...
%
% swtich_hands: 
%     Mapping right hand to left hand. This function expects a
%     trialSelection of the form (ntrials x 2n conditions). The conditions need
%     to be sorted alternating between hands cond1_left, cond1_right,
%     cond2_left, cond2_right, ...
%
%
%--------------------------------------------------------------------------
%
...
%%% Optional settings
    ...
    options.channels_new = [2,1,35,32,34,33,7,3,39,36,6,4,38,37,43,40,11,8,42,41,10,9,16,12,47,44,15,13,46,45,52,48,21,18,51,49,20,19,26,22,56,53,25,23,55,54,31,27,61,57,60,58,30,28];
...
[sig_ti_FDR,xa,length] = stats_rplv(rplv,stats);
...
clearvars -except rplv trials rplv_mean sig_ti_FDR xa length Agg bet hub community node_flex deg
